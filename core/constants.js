...
(() => {
    ...
    const EVENTS = deepFreeze({
        ...
        MODULE: {
            ...
            ERROR: "module:error",
            STATE_CHANGED: "module:state-changed",
        },
        ...
        UI: {
            ...
            MODULE_RENDERED: "ui:module-rendered",
            STATUS_CHANGED: "ui:status-changed",
        },
        ...
        DOM: {
            ...
            WALLET_CHANGED: "dom:wallet-changed",
            NAVIGATION_CHANGED:
        ...
        API: {
            ...
            QUEUE_CHANGED: "api:queue-changed",
        },
    ...
    const ERROR_CODES = deepFreeze({
        ...
        APP: {
            STARTUP_FAILED: "APP_STARTUP_FAILED",
            SHUTDOWN_FAILED: "APP_SHUTDOWN_FAILED",
            INVALID_STATE: "APP_INVALID_STATE",
        },

        DOM: {
            SELECTOR_MISSING: "DOM_SELECTOR_MISSING",
            TIMEOUT: "DOM_TIMEOUT",
            OBSERVER_FAILED: "DOM_OBSERVER_FAILED",
            PARSE_FAILED: "DOM_PARSE_FAILED",
            ELEMENT_NOT_VISIBLE:
        ...
        API: {
            ...
            REQUEST_FAILED: "API_REQUEST_FAILED",
            CACHE_FAILED: "API_CACHE_FAILED",
        },
        ...
        MODULE: {
            ...
            INIT_FAILED: "MODULE_INIT_FAILED",
            START_FAILED: "MODULE_START_FAILED",
            PAUSE_FAILED: "MODULE_PAUSE_FAILED",
            RESUME_FAILED: "MODULE_RESUME_FAILED",
            STOP_FAILED: "MODULE_STOP_FAILED",
            RENDER_FAILED: "MODULE_RENDER_FAILED",
            DESTROY_FAILED: "MODULE_DESTROY_FAILED",
            CRASHED: "MODULE_CRASHED",
        },

        SETTINGS: {
            CORRUPT: "SETTINGS_CORRUPT",
        ...
        LIFECYCLE: {
            ...
            START_FAILED: "LIFECYCLE_START_FAILED",
            STOP_FAILED: "LIFECYCLE_STOP_FAILED",
            RESTART_FAILED:
    ...
    const STORAGE_KEYS = deepFreeze({
        ...
        UI: {
            ...
            ACTIVE_MODULE: "ui:active-module",
            THEME: "ui:theme",
        },
    ...
    const DEFAULTS = deepFreeze({
        ...
        MAX_LOG_HISTORY: 500,
        DRAWER_WIDTH_PX: 420,
        UI_ANIMATION_DURATION_MS: 250,
        HEALTH_SCORE_MAXIMUM: 100,
        HEALTH_SCORE_MINIMUM: 0,
    });
     ...
     */
    TACTIC.constants = constants;

    /*
     * Convenience aliases.
     *
     * These make common usage shorter:
     *
     * TACTIC.EVENTS.MODULE.ERROR
     * TACTIC.ERROR_CODES.DOM.SELECTOR_MISSING
     * TACTIC.SEVERITY.WARNING
     */
    TACTIC.EVENTS = EVENTS;
    TACTIC.ERROR_CODES = ERROR_CODES;
    TACTIC.SEVERITY = SEVERITY;
    TACTIC.HEALTH_STATES = HEALTH_STATES;
    TACTIC.MODULE_STATES = MODULE_STATES;
    TACTIC.LIFECYCLE_STATES = LIFECYCLE_STATES;
    TACTIC.CAPABILITIES = CAPABILITIES;
    TACTIC.STORAGE_KEYS = STORAGE_KEYS;
    TACTIC.DEFAULTS = DEFAULTS;
